...
#End Region
        ...
        Private Sub filter_PopupCancel(ByVal sender As Object, ByVal e As  _
            XComboGrid.vbAccelerator.Components.Controls.PopupCancelEventArgs) Handles filter.PopupCancel
            OnPopupCancel(e)
        End Sub

        'Private Sub filter_PopupCancel(ByVal sender As Object, ByVal e As PopupControlVB.vbAccelerator.Components.Controls.PopupCancelEventArgs) Handles filter.PopupCancel
        '    OnPopupCancel(e)
        'End Sub
    End Class
#End Region
